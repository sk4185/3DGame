...
public class UIPT_LITE_Demo_Config : MonoBehaviour
{
	...
	private static UIPT_LITE_Demo_Config instance;

	// Public static reference that can be accesd from anywhere
	public static UIPT_LITE_Demo_Config Instance
	{
		get
		{
			...
			if (instance == null)
			{
				instance = GameObject.FindObjectOfType<UIPT_LITE_Demo_Config>();
				if (instance == null)
				{
					GameObject pGameObject = new GameObject();
					pGameObject.name = "Config";
					instance = pGameObject.AddComponent<UIPT_LITE_Demo_Config>();
				}
	...
	public eGraphicQuality m_Quality_Default = UIPT_LITE_Demo_Config.eGraphicQuality.High;
	...
	public eGraphicQuality m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.High;
	...
	public void Save()
	{
		...
		switch (m_Quality)
		{
			case UIPT_LITE_Demo_Config.eGraphicQuality.Low:
				PlayerPrefs.SetInt("GraphicQuality", 0);
				break;
			case UIPT_LITE_Demo_Config.eGraphicQuality.Medium:
				PlayerPrefs.SetInt("GraphicQuality", 1);
				break;
			case UIPT_LITE_Demo_Config.eGraphicQuality.High:
	...
	public void Load()
	{
		...
		if (PlayerPrefsIsAlreadyUsed == 1)
		{
			...
			{
				case 0:
					m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.Low;
					break;
				case 1:
					m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.Medium;
					break;
				case 2:
					m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.High;
					break;
			}
		}
		else
