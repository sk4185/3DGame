...
// ######################################################################
// UIPT_LITE_Demo04_GameplayAndLevelClear class
//
// Handles "Demo 04 - Landscape - Gameplay" and "Demo 04 - Portrait - Gameplay" scenes.
// ######################################################################

public class UIPT_LITE_Demo04_GameplayAndLevelClear : MonoBehaviour
{
	// ########################################
	// Variables
	// ########################################
	...
	// UIPT_LITE_Demo_Pause
	public UIPT_LITE_Demo_Pause m_Pause = null;
	...
	// UIPT_LITE_Demo_LevelClear
	public UIPT_LITE_Demo_LevelClear m_LevelClear = null;
	...
	// UIs
	public GUIAnimFREE m_Gameplay_MSG_Combo = null;
	public GUIAnimFREE m_Gameplay_MSG_GameOver = null;
	public GUIAnimFREE m_Gameplay_MSG_HEAL = null;
	public GUIAnimFREE m_Gameplay_MSG_LevelUp = null;
	public GUIAnimFREE m_Gameplay_MSG_Ready = null;
	public GUIAnimFREE m_Gameplay_MSG_Win = null;
	public GUIAnimFREE m_Gameplay_TopPanel = null;
	public GUIAnimFREE m_Gameplay_BottomPanel = null;
	...
	void Start()
	{
		...
		GUIAnimSystemFREE.Instance.MoveIn(m_Gameplay_TopPanel.transform, true);
		GUIAnimSystemFREE.Instance.MoveIn(m_Gameplay_BottomPanel.transform, true);
		...
		if (m_PlayerInfo.m_Item0.m_ItemCount > 0)
		{
			if (m_PlayerInfo.m_Item0.m_CoolDownTime < m_PlayerInfo.m_Item0.m_RequiredCoolDownTime)
			{
				...
				if (m_PlayerInfo.m_Item0.m_CoolDownTime >= m_PlayerInfo.m_Item0.m_RequiredCoolDownTime)
				{
					...
					UIPT_LITE_ParticleController.Instance.CreateParticle(m_Gameplay_FilledImage_Item0.gameObject, UIPT_LITE_ParticleController.Instance.m_PrefabFullFIll);
				}
			}
		}
		else
		...
		if (m_PlayerInfo.m_Item1.m_ItemCount > 0)
		{
			if (m_PlayerInfo.m_Item1.m_CoolDownTime < m_PlayerInfo.m_Item1.m_RequiredCoolDownTime)
			{
				...
				if (m_PlayerInfo.m_Item1.m_CoolDownTime >= m_PlayerInfo.m_Item1.m_RequiredCoolDownTime)
				{
					...
					UIPT_LITE_ParticleController.Instance.CreateParticle(m_Gameplay_FilledImage_Item1.gameObject, UIPT_LITE_ParticleController.Instance.m_PrefabFullFIll);
				}
			}
		}
		else
		...
		if (m_PlayerInfo.m_Item2.m_ItemCount > 0)
		{
			if (m_PlayerInfo.m_Item2.m_CoolDownTime < m_PlayerInfo.m_Item2.m_RequiredCoolDownTime)
			{
				...
				if (m_PlayerInfo.m_Item2.m_CoolDownTime >= m_PlayerInfo.m_Item2.m_RequiredCoolDownTime)
				{
					...
					UIPT_LITE_ParticleController.Instance.CreateParticle(m_Gameplay_FilledImage_Item2.gameObject, UIPT_LITE_ParticleController.Instance.m_PrefabFullFIll);
				}
			}
		}
		else
	...
	public void GamePlay_Button_Pause()
	{
		...
		UIPT_LITE_SoundController.Instance.Play_SoundPause();
	...
	public void GamePlay_Button_Item0(GameObject goButton)
	{
		if (m_PlayerInfo.m_Item0.m_ItemCount > 0)
		{
			...
			GUIAnimSystemFREE.Instance.MoveOut(m_PanelForButtons.transform, true);
			StartCoroutine(ShowMSG(m_Gameplay_MSG_HEAL));

			// Play Click sound
			UIPT_LITE_SoundController.Instance.Play_SoundClick();
			UIPT_LITE_ParticleController.Instance.CreateParticle(goButton, UIPT_LITE_ParticleController.Instance.m_PrefabUseItem);
		}
		else
		{
	...
	IEnumerator ShowMSG(GUIAnimFREE pGUIANimFREE)
	{
		// Disable GraphicRaycasters of Canvas in m_Gameplay
		// http://docs.unity3d.com/Manual/script-GraphicRaycaster.html
		GUIAnimSystemFREE.Instance.SetGraphicRaycasterEnable(m_Gameplay, false);
		...
		GUIAnimSystemFREE.Instance.PlayParticle(pGUIANimFREE.transform);
	...
	IEnumerator HideMSG(GUIAnimFREE pGUIANimFREE)
	{
		// Creates a yield instruction to wait for a given number of seconds
		// http://docs.unity3d.com/400/Documentation/ScriptReference/WaitForSeconds.WaitForSeconds.html
		...
		GUIAnimSystemFREE.Instance.StopParticle(pGUIANimFREE.transform);

		// Enable GraphicRaycasters of Canvas in m_Gameplay
		// http://docs.unity3d.com/Manual/script-GraphicRaycaster.html
		GUIAnimSystemFREE.Instance.SetGraphicRaycasterEnable(m_Gameplay, true);
		...
		// Play MoveIn animation
		GUIAnimSystemFREE.Instance.MoveIn(m_PanelForButtons.transform, true);
	}
	...
	public void GamePlay_Button_MSG_LevelClear()
	{
		...
		GUIAnimSystemFREE.Instance.MoveOut(m_Gameplay.transform, true);
		GUIAnimSystemFREE.Instance.MoveOut(m_PanelForButtons.transform, true);
	...
	IEnumerator Show_MSG_GameOver()
	{
		...
		// Play particles in the hierarchy of given transfrom
		GUIAnimSystemFREE.Instance.PlayParticle(m_Gameplay_MSG_GameOver.transform);
		...
		GUIAnimSystemFREE.Instance.DontDestroyParticleWhenLoadNewScene(m_Gameplay_MSG_GameOver.transform, true);
		...
		GUIAnimSystemFREE.Instance.LoadLevel("ToonyLITE Demo 03 - " + OrientationName + " - Level Select", 1.0f);
	}
