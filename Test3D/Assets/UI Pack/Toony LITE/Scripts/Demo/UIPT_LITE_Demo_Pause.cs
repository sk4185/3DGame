...
public class UIPT_LITE_Demo_Pause : UIPT_LITE_Demo_GUIPanel
{
	// ########################################
	// Variables
	// ########################################
	...
	public UIPT_LITE_Demo_Settings m_Settings = null;           // Keep UIPT_LITE_Demo_Settings class to show it when user presses Settings button
	...
	public void ShowMe()
	{
		...
		// Show this panel
		this.gameObject.GetComponent<UIPT_LITE_Demo_GUIPanel>().Show();
	}
	...
	public void HideMe()
	{
		...
		// Hide this panel
		this.gameObject.GetComponent<UIPT_LITE_Demo_GUIPanel>().Hide();
	}
