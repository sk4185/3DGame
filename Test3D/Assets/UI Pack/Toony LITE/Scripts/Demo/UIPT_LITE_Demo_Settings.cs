...
public class UIPT_LITE_Demo_Settings : UIPT_LITE_Demo_GUIPanel
{
	// ########################################
	// Variables
	// ########################################
	...
	void Start()
	{
		...
		UIPT_LITE_Demo_Config.Instance.Load();
	...
	{
		UIPT_LITE_Demo_Config.Instance.m_Music = m_Music.value;

		UIPT_LITE_SoundController.Instance.SetMusicVolume(m_Music.value);
	}

	public void Slider_Sound()
	{
		UIPT_LITE_Demo_Config.Instance.m_Sound = m_Sound.value;

		UIPT_LITE_SoundController.Instance.SetSoundVolume(m_Sound.value);

		// Play Yes sound
		UIPT_LITE_SoundController.Instance.Play_SoundYes();
	}
	...
	public void Slider_Vibration()
	{
		...
		{
			UIPT_LITE_Demo_Config.Instance.m_Vibration = true;
		}
		else
		{
			UIPT_LITE_Demo_Config.Instance.m_Vibration = false;
		}
	...
	{
		UIPT_LITE_Demo_Config.Instance.m_AutoUpdate = m_AutoUpdate.isOn;

		if (UIPT_LITE_Demo_Config.Instance.m_AutoUpdate)
		{
	...
	{
		UIPT_LITE_Demo_Config.Instance.m_Notifications = m_Notifications.isOn;

		if (UIPT_LITE_Demo_Config.Instance.m_Notifications)
		{
			// Play Yes button sound
			UIPT_LITE_SoundController.Instance.Play_SoundYes();
		}
	...
	public void Toggle_GraphicHigh()
	{
		...
		{
			UIPT_LITE_Demo_Config.Instance.m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.High;
			UIPT_LITE_SoundController.Instance.Play_SoundYes();
		}
	}
	...
	public void Toggle_GraphicMed()
	{
		...
		{
			UIPT_LITE_Demo_Config.Instance.m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.Medium;
			UIPT_LITE_SoundController.Instance.Play_SoundYes();
		}
	}
	...
	public void Toggle_GraphicLow()
	{
		...
		{
			UIPT_LITE_Demo_Config.Instance.m_Quality = UIPT_LITE_Demo_Config.eGraphicQuality.Low;
			UIPT_LITE_SoundController.Instance.Play_SoundYes();
		}
	}
	...
	public void Button_ResetToDefault()
	{
		...
		UIPT_LITE_Demo_Config.Instance.LoadDefault();
	...
	public void Button_Close()
	{
		...
		UIPT_LITE_Demo_Config.Instance.Save();
	...
	void UpdateUIs()
	{
		m_Music.value = UIPT_LITE_Demo_Config.Instance.m_Music;

		m_Sound.value = UIPT_LITE_Demo_Config.Instance.m_Sound;

		if (UIPT_LITE_Demo_Config.Instance.m_Vibration == true)
		{
			m_Vibration.value = 1;
		}
		else
		...
		m_AutoUpdate.isOn = UIPT_LITE_Demo_Config.Instance.m_AutoUpdate;

		m_Notifications.isOn = UIPT_LITE_Demo_Config.Instance.m_Notifications;

		if (UIPT_LITE_Demo_Config.Instance.m_Quality == UIPT_LITE_Demo_Config.eGraphicQuality.High)
			m_GraphicQualityHigh.isOn = true;
		else if (UIPT_LITE_Demo_Config.Instance.m_Quality == UIPT_LITE_Demo_Config.eGraphicQuality.Medium)
			m_GraphicQualityMed.isOn = true;
		else if (UIPT_LITE_Demo_Config.Instance.m_Quality == UIPT_LITE_Demo_Config.eGraphicQuality.Low)
